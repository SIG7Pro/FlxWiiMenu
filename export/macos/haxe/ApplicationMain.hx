...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxWiiMenu", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlxWiiMenu", null, 608, 456);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "65";
		app.meta["company"] = "ElastedAlorian";
		app.meta["file"] = "FlxWiiMenu";
		app.meta["name"] = "HaxeFlixel Wii Menu";
		...
		#elseif air
		app.window.title = "HaxeFlixel Wii Menu";
		#else
