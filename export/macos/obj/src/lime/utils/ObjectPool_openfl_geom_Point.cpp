...
HX_DEFINE_STACK_FRAME(_hx_pos_68de5308f7101ccb_22_new,"lime.utils.ObjectPool_openfl_geom_Point","new",0xd511c7a0,"lime.utils.ObjectPool_openfl_geom_Point.new","lime/utils/ObjectPool.hx",22,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_48_add,"lime.utils.ObjectPool_openfl_geom_Point","add",0xd507e961,"lime.utils.ObjectPool_openfl_geom_Point.add","lime/utils/ObjectPool.hx",48,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_56___default_clean,"lime.utils.ObjectPool_openfl_geom_Point","__default_clean",0x374d286b,"lime.utils.ObjectPool_openfl_geom_Point.__default_clean","lime/utils/ObjectPool.hx",56,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_59_clear,"lime.utils.ObjectPool_openfl_geom_Point","clear",0x41f5b8cd,"lime.utils.ObjectPool_openfl_geom_Point.clear","lime/utils/ObjectPool.hx",59,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_72___default_create,"lime.utils.ObjectPool_openfl_geom_Point","__default_create",0xa09db5da,"lime.utils.ObjectPool_openfl_geom_Point.__default_create","lime/utils/ObjectPool.hx",72,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_76_get,"lime.utils.ObjectPool_openfl_geom_Point","get",0xd50c77d6,"lime.utils.ObjectPool_openfl_geom_Point.get","lime/utils/ObjectPool.hx",76,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_98_release,"lime.utils.ObjectPool_openfl_geom_Point","release",0xa3181d07,"lime.utils.ObjectPool_openfl_geom_Point.release","lime/utils/ObjectPool.hx",98,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_125_remove,"lime.utils.ObjectPool_openfl_geom_Point","remove",0x71ecad04,"lime.utils.ObjectPool_openfl_geom_Point.remove","lime/utils/ObjectPool.hx",125,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_151___addInactive,"lime.utils.ObjectPool_openfl_geom_Point","__addInactive",0xb81816cc,"lime.utils.ObjectPool_openfl_geom_Point.__addInactive","lime/utils/ObjectPool.hx",151,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_173___getInactive,"lime.utils.ObjectPool_openfl_geom_Point","__getInactive",0xacafa241,"lime.utils.ObjectPool_openfl_geom_Point.__getInactive","lime/utils/ObjectPool.hx",173,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_212___removeInactive,"lime.utils.ObjectPool_openfl_geom_Point","__removeInactive",0x88ae5faf,"lime.utils.ObjectPool_openfl_geom_Point.__removeInactive","lime/utils/ObjectPool.hx",212,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_249_get_size,"lime.utils.ObjectPool_openfl_geom_Point","get_size",0x67281d0a,"lime.utils.ObjectPool_openfl_geom_Point.get_size","lime/utils/ObjectPool.hx",249,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_68de5308f7101ccb_253_set_size,"lime.utils.ObjectPool_openfl_geom_Point","set_size",0x1585767e,"lime.utils.ObjectPool_openfl_geom_Point.set_size","lime/utils/ObjectPool.hx",253,0xc114d76b)
namespace lime{
namespace utils{

void ObjectPool_openfl_geom_Point_obj::__construct( ::Dynamic create, ::Dynamic clean, ::Dynamic size){
            	HX_GC_STACKFRAME(&_hx_pos_68de5308f7101ccb_22_new)
...
bool ObjectPool_openfl_geom_Point_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x24dd4db0;
}

void ObjectPool_openfl_geom_Point_obj::add( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_48_add)
...
void _hx_run( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_56___default_clean)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

void ObjectPool_openfl_geom_Point_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_68de5308f7101ccb_59_clear)
...
HX_BEGIN_DEFAULT_FUNC(__default_create,ObjectPool_openfl_geom_Point_obj)
 ::openfl::geom::Point _hx_run(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_72___default_create)
...
HX_END_DEFAULT_FUNC
 ...
 ::openfl::geom::Point ObjectPool_openfl_geom_Point_obj::get(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_76_get)
HXLINE(  77)		 ::openfl::geom::Point object = null();
HXLINE(  79)		if ((this->inactiveObjects > 0)) {
HXLINE(  81)			 ::openfl::geom::Point object1 = null();
...
HXLINE(  81)					object1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
HXDLIN(  81)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE(  81)						this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            					}
HXDLIN(  81)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE(  81)						this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            					}
            				}
            			}
...
HXLINE(  85)				object = ( ( ::openfl::geom::Point)(this->create()) );
...
void ObjectPool_openfl_geom_Point_obj::release( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_98_release)
...
void ObjectPool_openfl_geom_Point_obj::remove( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_125_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Point_obj,remove,(void))

void ObjectPool_openfl_geom_Point_obj::_hx___addInactive( ::openfl::geom::Point object){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_151___addInactive)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Point_obj,_hx___addInactive,(void))
 ...
 ::openfl::geom::Point ObjectPool_openfl_geom_Point_obj::_hx___getInactive(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_173___getInactive)
HXLINE( 174)		 ::openfl::geom::Point object = null();
...
HXLINE( 188)				object = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
HXLINE( 190)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 192)					this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Point >();
            				}
...
void ObjectPool_openfl_geom_Point_obj::_hx___removeInactive(int count){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_212___removeInactive)
...
HXLINE( 235)				 ::openfl::geom::Point val = ( ( ::openfl::geom::Point)(_g_head->item) );
HXDLIN( 235)				_g_head = _g_head->next;
HXDLIN( 235)				 ::openfl::geom::Point object = val;
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Point_obj,_hx___removeInactive,(void))
 ...
 ::Dynamic ObjectPool_openfl_geom_Point_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_249_get_size)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Point_obj,get_size,return )
 ...
 ::Dynamic ObjectPool_openfl_geom_Point_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_68de5308f7101ccb_253_set_size)
...
HXLINE( 269)					 ::openfl::geom::Point object;
HXLINE( 271)					{
HXLINE( 271)						int _g = 0;
...
HXLINE( 273)							object = ( ( ::openfl::geom::Point)(this->create()) );
...
static ::hx::StorageInfo ObjectPool_openfl_geom_Point_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(ObjectPool_openfl_geom_Point_obj,activeObjects),HX_("activeObjects",ae,b3,18,3a)},
	{::hx::fsInt,(int)offsetof(ObjectPool_openfl_geom_Point_obj,inactiveObjects),HX_("inactiveObjects",a9,0c,c7,fb)},
	{::hx::fsObject /*  ::openfl::geom::Point */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,_hx___inactiveObject0),HX_("__inactiveObject0",46,3d,21,7f)},
	{::hx::fsObject /*  ::openfl::geom::Point */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,_hx___inactiveObject1),HX_("__inactiveObject1",47,3d,21,7f)},
	{::hx::fsObject /*  ::haxe::ds::List */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,_hx___inactiveObjectList),HX_("__inactiveObjectList",28,dd,99,7e)},
	{::hx::fsObject /*  ::haxe::ds::ObjectMap */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,_hx___pool),HX_("__pool",fc,e3,54,f9)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,_hx___size),HX_("__size",e1,03,4c,fb)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,clean),HX_("clean",89,71,5b,48)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,create),HX_("create",fc,66,0f,7c)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	ObjectPool_openfl_geom_Point_obj _hx_dummy;
	ObjectPool_openfl_geom_Point_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.utils.ObjectPool_openfl_geom_Point",ae,b7,f5,93);
