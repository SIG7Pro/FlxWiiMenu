...
HX_DEFINE_STACK_FRAME(_hx_pos_41782c565fbd7fd5_22_new,"lime.utils.ObjectPool_openfl_geom_Matrix","new",0xf75d9395,"lime.utils.ObjectPool_openfl_geom_Matrix.new","lime/utils/ObjectPool.hx",22,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_48_add,"lime.utils.ObjectPool_openfl_geom_Matrix","add",0xf753b556,"lime.utils.ObjectPool_openfl_geom_Matrix.add","lime/utils/ObjectPool.hx",48,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_56___default_clean,"lime.utils.ObjectPool_openfl_geom_Matrix","__default_clean",0x82d58fe0,"lime.utils.ObjectPool_openfl_geom_Matrix.__default_clean","lime/utils/ObjectPool.hx",56,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_59_clear,"lime.utils.ObjectPool_openfl_geom_Matrix","clear",0x67c42c02,"lime.utils.ObjectPool_openfl_geom_Matrix.clear","lime/utils/ObjectPool.hx",59,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_72___default_create,"lime.utils.ObjectPool_openfl_geom_Matrix","__default_create",0x6c6fd4c5,"lime.utils.ObjectPool_openfl_geom_Matrix.__default_create","lime/utils/ObjectPool.hx",72,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_76_get,"lime.utils.ObjectPool_openfl_geom_Matrix","get",0xf75843cb,"lime.utils.ObjectPool_openfl_geom_Matrix.get","lime/utils/ObjectPool.hx",76,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_98_release,"lime.utils.ObjectPool_openfl_geom_Matrix","release",0xafd1877c,"lime.utils.ObjectPool_openfl_geom_Matrix.release","lime/utils/ObjectPool.hx",98,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_125_remove,"lime.utils.ObjectPool_openfl_geom_Matrix","remove",0x60c3082f,"lime.utils.ObjectPool_openfl_geom_Matrix.remove","lime/utils/ObjectPool.hx",125,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_151___addInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__addInactive",0x7a0c4701,"lime.utils.ObjectPool_openfl_geom_Matrix.__addInactive","lime/utils/ObjectPool.hx",151,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_173___getInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__getInactive",0x6ea3d276,"lime.utils.ObjectPool_openfl_geom_Matrix.__getInactive","lime/utils/ObjectPool.hx",173,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_212___removeInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__removeInactive",0x54807e9a,"lime.utils.ObjectPool_openfl_geom_Matrix.__removeInactive","lime/utils/ObjectPool.hx",212,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_249_get_size,"lime.utils.ObjectPool_openfl_geom_Matrix","get_size",0x7cabd8f5,"lime.utils.ObjectPool_openfl_geom_Matrix.get_size","lime/utils/ObjectPool.hx",249,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_253_set_size,"lime.utils.ObjectPool_openfl_geom_Matrix","set_size",0x2b093269,"lime.utils.ObjectPool_openfl_geom_Matrix.set_size","lime/utils/ObjectPool.hx",253,0xc114d76b)
namespace lime{
namespace utils{

void ObjectPool_openfl_geom_Matrix_obj::__construct( ::Dynamic create, ::Dynamic clean, ::Dynamic size){
            	HX_GC_STACKFRAME(&_hx_pos_41782c565fbd7fd5_22_new)
...
bool ObjectPool_openfl_geom_Matrix_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x6f4bba7d;
}

void ObjectPool_openfl_geom_Matrix_obj::add( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_48_add)
...
void _hx_run( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_56___default_clean)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

void ObjectPool_openfl_geom_Matrix_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_41782c565fbd7fd5_59_clear)
...
HX_BEGIN_DEFAULT_FUNC(__default_create,ObjectPool_openfl_geom_Matrix_obj)
 ::openfl::geom::Matrix _hx_run(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_72___default_create)
...
HX_END_DEFAULT_FUNC
 ...
 ::openfl::geom::Matrix ObjectPool_openfl_geom_Matrix_obj::get(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_76_get)
HXLINE(  77)		 ::openfl::geom::Matrix object = null();
HXLINE(  79)		if ((this->inactiveObjects > 0)) {
HXLINE(  81)			 ::openfl::geom::Matrix object1 = null();
...
HXLINE(  81)					object1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
HXDLIN(  81)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE(  81)						this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            					}
HXDLIN(  81)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE(  81)						this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            					}
            				}
            			}
...
HXLINE(  85)				object = ( ( ::openfl::geom::Matrix)(this->create()) );
...
void ObjectPool_openfl_geom_Matrix_obj::release( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_98_release)
...
void ObjectPool_openfl_geom_Matrix_obj::remove( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_125_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Matrix_obj,remove,(void))

void ObjectPool_openfl_geom_Matrix_obj::_hx___addInactive( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_151___addInactive)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Matrix_obj,_hx___addInactive,(void))
 ...
 ::openfl::geom::Matrix ObjectPool_openfl_geom_Matrix_obj::_hx___getInactive(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_173___getInactive)
HXLINE( 174)		 ::openfl::geom::Matrix object = null();
...
HXLINE( 188)				object = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 190)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 192)					this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            				}
HXLINE( 195)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 197)					this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            				}
            			}
            		}
...
void ObjectPool_openfl_geom_Matrix_obj::_hx___removeInactive(int count){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_212___removeInactive)
...
HXLINE( 235)				 ::openfl::geom::Matrix val = ( ( ::openfl::geom::Matrix)(_g_head->item) );
HXDLIN( 235)				_g_head = _g_head->next;
HXDLIN( 235)				 ::openfl::geom::Matrix object = val;
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Matrix_obj,_hx___removeInactive,(void))
 ...
 ::Dynamic ObjectPool_openfl_geom_Matrix_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_249_get_size)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Matrix_obj,get_size,return )
 ...
 ::Dynamic ObjectPool_openfl_geom_Matrix_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_253_set_size)
...
HXLINE( 269)					 ::openfl::geom::Matrix object;
HXLINE( 271)					{
HXLINE( 271)						int _g = 0;
...
HXLINE( 273)							object = ( ( ::openfl::geom::Matrix)(this->create()) );
...
static ::hx::StorageInfo ObjectPool_openfl_geom_Matrix_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,activeObjects),HX_("activeObjects",ae,b3,18,3a)},
	{::hx::fsInt,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,inactiveObjects),HX_("inactiveObjects",a9,0c,c7,fb)},
	{::hx::fsObject /*  ::openfl::geom::Matrix */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,_hx___inactiveObject0),HX_("__inactiveObject0",46,3d,21,7f)},
	{::hx::fsObject /*  ::openfl::geom::Matrix */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,_hx___inactiveObject1),HX_("__inactiveObject1",47,3d,21,7f)},
	{::hx::fsObject /*  ::haxe::ds::List */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,_hx___inactiveObjectList),HX_("__inactiveObjectList",28,dd,99,7e)},
	{::hx::fsObject /*  ::haxe::ds::ObjectMap */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,_hx___pool),HX_("__pool",fc,e3,54,f9)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,_hx___size),HX_("__size",e1,03,4c,fb)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,clean),HX_("clean",89,71,5b,48)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ObjectPool_openfl_geom_Matrix_obj,create),HX_("create",fc,66,0f,7c)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	ObjectPool_openfl_geom_Matrix_obj _hx_dummy;
	ObjectPool_openfl_geom_Matrix_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("lime.utils.ObjectPool_openfl_geom_Matrix",23,25,a5,a7);
