...
HX_LOCAL_STACK_FRAME(_hx_pos_20ad791bf00c982a_204_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/local/lib/haxe/std/haxe/io/BytesBuffer.hx",204,0xad7eed50)
namespace haxe{
namespace io{
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_20ad791bf00c982a_204_getBytes)
