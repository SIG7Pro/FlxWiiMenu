...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FlxWiiMenu",24,2b,64,27),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("65",3f,2f,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("ElastedAlorian",6e,4c,b3,58));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FlxWiiMenu",24,2b,64,27));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("HaxeFlixel Wii Menu",26,fb,b9,16));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),608)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),456)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("HaxeFlixel Wii Menu",26,fb,b9,16))
