...
HX_DEFINE_DYNAMIC_FUNC0(ColorTransform_obj,_hx___toLimeColorMatrix,return )
 ...
 ::lime::utils::ObjectPool_openfl_geom_ColorTransform ColorTransform_obj::_hx___pool;
...
bool ColorTransform_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"__pool") ) { _hx___pool=ioValue.Cast<  ::lime::utils::ObjectPool_openfl_geom_ColorTransform >(); return true; }
		break;
	case 17:
...
static ::hx::StaticInfo ColorTransform_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool_openfl_geom_ColorTransform */ ,(void *) &ColorTransform_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXLINE(  60)			ct->_hx___identity();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_59_boot)
HXDLIN(  59)		_hx___pool =  ::lime::utils::ObjectPool_openfl_geom_ColorTransform_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
