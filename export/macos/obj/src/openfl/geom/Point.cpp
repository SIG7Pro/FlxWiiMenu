...
static ::hx::StaticInfo Point_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::lime::utils::ObjectPool_openfl_geom_Point */ ,(void *) &Point_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
...
HXDLIN(  37)			p->setTo(( (Float)(0) ),( (Float)(0) ));
            	...
            	HX_GC_STACKFRAME(&_hx_pos_35745b0e94bdaa0e_37_boot)
HXDLIN(  37)		_hx___pool =  ::lime::utils::ObjectPool_openfl_geom_Point_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
