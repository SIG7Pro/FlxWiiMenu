...
static ::hx::StaticInfo Rectangle_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool_openfl_geom_Rectangle */ ,(void *) &Rectangle_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXLINE(  63)			r->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ));
            	...
            	HX_GC_STACKFRAME(&_hx_pos_45de901e99b61471_62_boot)
HXDLIN(  62)		_hx___pool =  ::lime::utils::ObjectPool_openfl_geom_Rectangle_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
