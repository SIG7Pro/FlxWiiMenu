...
HXLINE( 289)		 ::openfl::geom::Rectangle bounds = ::openfl::geom::Rectangle_obj::_hx___pool->get();
...
HXLINE( 431)		 ::openfl::geom::Point point = ::openfl::geom::Point_obj::_hx___pool->get();
