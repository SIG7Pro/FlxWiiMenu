...
HX_DEFINE_DYNAMIC_FUNC0(TouchData_obj,reset,(void))
 ...
 ::lime::utils::ObjectPool_openfl_utils__internal_TouchData TouchData_obj::_hx___pool;
...
bool TouchData_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"__pool") ) { _hx___pool=ioValue.Cast<  ::lime::utils::ObjectPool_openfl_utils__internal_TouchData >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo TouchData_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::lime::utils::ObjectPool_openfl_utils__internal_TouchData */ ,(void *) &TouchData_obj::_hx___pool,HX_("__pool",fc,e3,54,f9)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
HXDLIN(  16)			data->reset();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_76b1f70d22d64ab9_16_boot)
HXDLIN(  16)		_hx___pool =  ::lime::utils::ObjectPool_openfl_utils__internal_TouchData_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
