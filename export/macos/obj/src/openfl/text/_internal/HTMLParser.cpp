...
HXLINE( 102)					::String segment1 = segments->__get(_g);
HXDLIN( 102)					_g = (_g + 1);
HXLINE( 104)					if ((segment1 == HX_("",00,00,00,00))) {
HXLINE( 104)						continue;
            					}
HXLINE( 106)					bool isClosingTag = (segment1.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE( 107)					int tagEndIndex = segment1.indexOf(HX_(">",3e,00,00,00),null());
HXLINE( 108)					int start = (tagEndIndex + 1);
HXLINE( 109)					int spaceIndex = segment1.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN( 110)					::String tagName3 = segment1.substring(tagName,tagName1).toLowerCase();
...
HXLINE( 138)						if ((start < segment1.length)) {
HXLINE( 140)							sub = ::StringTools_obj::htmlUnescape(segment1.substr(start,null()));
...
HXLINE( 156)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexClass->match(segment1)) {
...
HXLINE( 172)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexHref->match(segment1)) {
...
HXLINE( 202)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexFace->match(segment1)) {
...
HXLINE( 207)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexColor->match(segment1)) {
...
HXLINE( 212)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexSize->match(segment1)) {
...
HXLINE( 183)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexAlign->match(segment1)) {
...
HXLINE( 238)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexBlockIndent->match(segment1)) {
...
HXLINE( 243)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexIndent->match(segment1)) {
...
HXLINE( 248)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeading->match(segment1)) {
...
HXLINE( 253)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeftMargin->match(segment1)) {
...
HXLINE( 258)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexRightMargin->match(segment1)) {
...
HXLINE( 263)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexTabStops->match(segment1)) {
...
HXLINE( 280)							if ((start < segment1.length)) {
HXLINE( 282)								sub = ::StringTools_obj::htmlUnescape(segment1.substring(start,null()));
...
HXLINE( 290)							sub = ::StringTools_obj::htmlUnescape(segment1);
