...
HXLINE( 391)			 ::Dynamic vendor = this->gl->getParameter(this->gl->VENDOR);
HXLINE( 392)			 ::Dynamic version = this->gl->getParameter(this->gl->VERSION);
HXLINE( 393)			 ::Dynamic renderer = this->gl->getParameter(this->gl->RENDERER);
HXLINE( 394)			 ::Dynamic glslVersion = this->gl->getParameter(this->gl->SHADING_LANGUAGE_VERSION);
HXLINE( 396)			::String _hx_tmp1 = ((HX_("OpenGL Vendor=",04,c1,2f,f5) + ::Std_obj::string(vendor)) + HX_(" Version=",65,2a,97,0e));
HXDLIN( 396)			::String _hx_tmp2 = ((_hx_tmp1 + ::Std_obj::string(version)) + HX_(" Renderer=",5a,b1,92,78));
HXDLIN( 396)			::String _hx_tmp3 = ((_hx_tmp2 + ::Std_obj::string(renderer)) + HX_(" GLSL=",5f,30,5a,df));
HXDLIN( 396)			::openfl::display3D::Context3D_obj::_hx___driverInfo = (_hx_tmp3 + ::Std_obj::string(glslVersion));
            		}
