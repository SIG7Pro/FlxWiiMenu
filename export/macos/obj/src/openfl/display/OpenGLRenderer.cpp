...
HXLINE( 168)		this->_hx___scrollRectMasks =  ::lime::utils::ObjectPool_openfl_display_Shape_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()),null(),null());
...
HXLINE( 495)		 ::openfl::geom::Matrix _matrix = ::openfl::geom::Matrix_obj::_hx___pool->get();
...
HXLINE( 688)				 ::openfl::display::Shape shape = this->_hx___scrollRectMasks->get();
...
HXLINE( 716)		 ::openfl::geom::Matrix _matrix = ::openfl::geom::Matrix_obj::_hx___pool->get();
...
static ::hx::StorageInfo OpenGLRenderer_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::utils::ObjectPool_openfl_display_Shape */ ,(int)offsetof(OpenGLRenderer_obj,_hx___scrollRectMasks),HX_("__scrollRectMasks",56,dd,1f,f7)},
