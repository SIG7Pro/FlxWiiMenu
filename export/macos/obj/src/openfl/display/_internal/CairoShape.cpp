...
HXLINE(  69)					 ::openfl::geom::Matrix renderTransform = ::openfl::geom::Matrix_obj::_hx___pool->get();
...
HXLINE( 163)					 ::openfl::geom::Matrix renderTransform1 = ::openfl::geom::Matrix_obj::_hx___pool->get();
