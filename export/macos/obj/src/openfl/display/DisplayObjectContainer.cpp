...
HXLINE( 719)		 ::openfl::geom::Matrix childWorldTransform = ::openfl::geom::Matrix_obj::_hx___pool->get();
HXLINE( 721)		{
HXLINE( 721)			int _g = 0;
...
HXLINE( 740)		 ::openfl::geom::Matrix childWorldTransform = ::openfl::geom::Matrix_obj::_hx___pool->get();
HXLINE( 742)		{
HXLINE( 742)			int _g = 0;
...
HXLINE( 748)				 ::openfl::geom::Rectangle childRect = ::openfl::geom::Rectangle_obj::_hx___pool->get();
...
HXLINE( 773)		 ::openfl::geom::Matrix childWorldTransform = ::openfl::geom::Matrix_obj::_hx___pool->get();
HXLINE( 775)		{
HXLINE( 775)			int _g = 0;
...
HXLINE( 795)			 ::openfl::geom::Point point = ::openfl::geom::Point_obj::_hx___pool->get();
