...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxDirectionFlags_Impl__obj,fromBools,return )
 ...
 ::Dynamic FlxDirectionFlags_Impl__obj::_hx_and;

 ::Dynamic FlxDirectionFlags_Impl__obj::_hx_or;

 ::Dynamic FlxDirectionFlags_Impl__obj::gt;

 ::Dynamic FlxDirectionFlags_Impl__obj::lt;

 ::Dynamic FlxDirectionFlags_Impl__obj::gte;

 ::Dynamic FlxDirectionFlags_Impl__obj::lte;
...
bool FlxDirectionFlags_Impl__obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		if (HX_FIELD_EQ(inName,"or") ) { outValue = ( _hx_or ); return true; }
		if (HX_FIELD_EQ(inName,"gt") ) { outValue = ( gt ); return true; }
		if (HX_FIELD_EQ(inName,"lt") ) { outValue = ( lt ); return true; }
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"has") ) { outValue = has_dyn(); return true; }
		if (HX_FIELD_EQ(inName,"and") ) { outValue = ( _hx_and ); return true; }
		if (HX_FIELD_EQ(inName,"gte") ) { outValue = ( gte ); return true; }
		if (HX_FIELD_EQ(inName,"lte") ) { outValue = ( lte ); return true; }
		break;
	case 4:
...
bool FlxDirectionFlags_Impl__obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"or") ) { _hx_or=ioValue.Cast<  ::Dynamic >(); return true; }
		if (HX_FIELD_EQ(inName,"gt") ) { gt=ioValue.Cast<  ::Dynamic >(); return true; }
		if (HX_FIELD_EQ(inName,"lt") ) { lt=ioValue.Cast<  ::Dynamic >(); return true; }
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"and") ) { _hx_and=ioValue.Cast<  ::Dynamic >(); return true; }
		if (HX_FIELD_EQ(inName,"gte") ) { gte=ioValue.Cast<  ::Dynamic >(); return true; }
		if (HX_FIELD_EQ(inName,"lte") ) { lte=ioValue.Cast<  ::Dynamic >(); return true; }
	}
	return false;
}
...
void FlxDirectionFlags_Impl__obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxDirectionFlags_Impl__obj::__SetStatic;
