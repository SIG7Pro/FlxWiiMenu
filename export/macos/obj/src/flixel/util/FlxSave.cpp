...
HXLINE( 281)		if ((this->status->_hx_getIndex() == 1)) {
...
HXLINE( 325)			::String n = _g->_hx_getString(0);
HXDLIN( 325)			return n;
            		}
            		else {
...
HXLINE( 335)			::String p = _g->_hx_getString(1);
HXDLIN( 335)			return p;
            		}
            		else {
...
HXDLIN( 342)		if ((this->status->_hx_getIndex() == 1)) {
