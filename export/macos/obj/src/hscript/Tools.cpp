...
HXLINE(  54)							{
HXLINE(  54)								int _g6 = 0;
HXDLIN(  54)								::Array< ::Dynamic> _g7 = ( (::Array< ::Dynamic>)(c4->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN(  54)								while((_g6 < _g7->length)){
HXLINE(  54)									 ::hscript::Expr v = _g7->__get(_g6).StaticCast<  ::hscript::Expr >();
HXDLIN(  54)									_g6 = (_g6 + 1);
HXDLIN(  54)									f(v);
            								}
            							}
...
HXLINE(  58)						int _g8 = 0;
HXDLIN(  58)						while((_g8 < args1->length)){
HXLINE(  58)							 ::hscript::Expr a1 = args1->__get(_g8).StaticCast<  ::hscript::Expr >();
HXDLIN(  58)							_g8 = (_g8 + 1);
HXDLIN(  58)							f(a1);
            						}
            					}
...
HXLINE(  72)						 ::hscript::Expr a = args->__get(_g3).StaticCast<  ::hscript::Expr >();
HXDLIN(  72)						_g3 = (_g3 + 1);
...
HXDLIN(  80)				::Array< ::Dynamic> _g4 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  80)				{
HXLINE(  80)					int _g5 = 0;
HXDLIN(  80)					while((_g5 < el1->length)){
HXLINE(  80)						 ::hscript::Expr e14 = el1->__get(_g5).StaticCast<  ::hscript::Expr >();
HXDLIN(  80)						_g5 = (_g5 + 1);
HXDLIN(  80)						_g4->push(f(e14));
            					}
            				}
HXLINE(  64)				edef = ::hscript::Expr_obj::EArrayDecl(_g4);
            			}
            			break;
            			case (int)18: {
HXLINE(  81)				::String cl = e->_hx_getString(0);
HXDLIN(  81)				::Array< ::Dynamic> el2 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  81)				::Array< ::Dynamic> _g6 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  81)				{
HXLINE(  81)					int _g7 = 0;
HXDLIN(  81)					while((_g7 < el2->length)){
HXLINE(  81)						 ::hscript::Expr e15 = el2->__get(_g7).StaticCast<  ::hscript::Expr >();
HXDLIN(  81)						_g7 = (_g7 + 1);
HXDLIN(  81)						_g6->push(f(e15));
            					}
            				}
HXLINE(  64)				edef = ::hscript::Expr_obj::ENew(cl,_g6);
            			}
            			break;
            			case (int)19: {
...
HXDLIN(  84)				::Array< ::Dynamic> _g8 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  84)				{
HXLINE(  84)					int _g9 = 0;
HXDLIN(  84)					while((_g9 < fl->length)){
HXLINE(  84)						 ::Dynamic fi1 = fl->__get(_g9);
HXDLIN(  84)						_g9 = (_g9 + 1);
HXDLIN(  84)						::String fi2 = ( (::String)(fi1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXDLIN(  84)						_g8->push( ::Dynamic(::hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("e",65,00,00,00),f( ::Dynamic(fi1->__Field(HX_("e",65,00,00,00),::hx::paccDynamic))))
            							->setFixed(1,HX_("name",4b,72,ff,48),fi2)));
            					}
            				}
HXLINE(  64)				edef = ::hscript::Expr_obj::EObject(_g8);
            			}
            			break;
            			case (int)22: {
...
HXDLIN(  86)				::Array< ::Dynamic> _g10 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  86)				{
HXLINE(  86)					int _g11 = 0;
HXDLIN(  86)					while((_g11 < cases->length)){
HXLINE(  86)						 ::Dynamic c4 = cases->__get(_g11);
HXDLIN(  86)						_g11 = (_g11 + 1);
HXDLIN(  86)						::Array< ::Dynamic> _g12 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  86)						{
HXLINE(  86)							int _g13 = 0;
HXDLIN(  86)							::Array< ::Dynamic> _g14 = ( (::Array< ::Dynamic>)(c4->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN(  86)							while((_g13 < _g14->length)){
HXLINE(  86)								 ::hscript::Expr v2 = _g14->__get(_g13).StaticCast<  ::hscript::Expr >();
HXDLIN(  86)								_g13 = (_g13 + 1);
HXDLIN(  86)								_g12->push(f(v2));
            							}
            						}
HXDLIN(  86)						_g10->push( ::Dynamic(::hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("expr",35,fd,1d,43),f( ::Dynamic(c4->__Field(HX_("expr",35,fd,1d,43),::hx::paccDynamic))))
            							->setFixed(1,HX_("values",e2,03,b7,4f),_g12)));
            					}
            				}
...
HXLINE(  64)				edef = ::hscript::Expr_obj::ESwitch(edef14,_g10,edef15);
            			}
            			break;
            			case (int)24: {
...
HXLINE(  87)					::Array< ::Dynamic> _g15 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  87)					{
HXLINE(  87)						int _g16 = 0;
HXDLIN(  87)						while((_g16 < args2->length)){
HXLINE(  87)							 ::hscript::Expr a1 = args2->__get(_g16).StaticCast<  ::hscript::Expr >();
HXDLIN(  87)							_g16 = (_g16 + 1);
HXDLIN(  87)							_g15->push(f(a1));
            						}
            					}
HXDLIN(  87)					edef17 = _g15;
            				}
