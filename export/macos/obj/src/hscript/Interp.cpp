...
HXLINE( 336)				return this->resolve(id);
            			...
            			break;
            			case (int)2: {
HXLINE( 337)				::String n = e->_hx_getString(0);
...
HXLINE( 346)						 ::hscript::Expr e3 = exprs->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 346)						_g = (_g + 1);
...
HXDLIN( 377)					while((_g1 < params->length)){
HXLINE( 377)						 ::hscript::Expr p = params->__get(_g1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 406)				::Array< ::Dynamic> params1 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 410)					while((_g2 < params1->length)){
HXLINE( 410)						 ::Dynamic p1 = params1->__get(_g2);
...
HXLINE( 478)					 ::hscript::Expr _g3 = arr1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)					if ((_g3->_hx_getIndex() == 6)) {
HXLINE( 478)						if ((_g3->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXDLIN( 485)						while((_g4 < arr1->length)){
HXLINE( 485)							 ::hscript::Expr e17 = arr1->__get(_g4).StaticCast<  ::hscript::Expr >();
HXDLIN( 485)							_g4 = (_g4 + 1);
...
HXLINE( 507)					{
HXLINE( 507)						int _g5 = 0;
HXDLIN( 507)						int _g6 = keys->get_length();
HXDLIN( 507)						while((_g5 < _g6)){
HXLINE( 507)							_g5 = (_g5 + 1);
HXDLIN( 507)							int n1 = (_g5 - 1);
...
HXLINE( 514)					{
HXLINE( 514)						int _g7 = 0;
HXDLIN( 514)						while((_g7 < arr1->length)){
HXLINE( 514)							 ::hscript::Expr e18 = arr1->__get(_g7).StaticCast<  ::hscript::Expr >();
HXDLIN( 514)							_g7 = (_g7 + 1);
...
HXLINE( 530)				{
HXLINE( 530)					int _g8 = 0;
HXDLIN( 530)					while((_g8 < params2->length)){
HXLINE( 530)						 ::hscript::Expr e19 = params2->__get(_g8).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)						_g8 = (_g8 + 1);
...
HXLINE( 534)				HX_STACK_DO_THROW(this->expr(e20));
            			...
            			break;
            			case (int)20: {
HXLINE( 535)				 ::hscript::Expr e23 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 546)						HX_STACK_DO_THROW(err1);
            						...
            						HX_STACK_BEGIN_CATCH
            						 ::haxe::ValueException _g9 = _hx_e;
HXLINE( 544)						{
HXLINE( 544)							null();
            						}
HXLINE( 538)						if (::Std_obj::isOfType(_g9->value,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 544)							 ::hscript::_Interp::Stop err1 = _g9->value;
HXLINE( 545)							this->inTry = oldTry;
HXLINE( 546)							HX_STACK_DO_THROW(err1);
            						}
            						else {
HXLINE( 538)							HX_STACK_DO_THROW(_g9);
            						}
            					}
...
HXLINE( 560)				{
HXLINE( 560)					int _g11 = 0;
HXDLIN( 560)					while((_g11 < fl->length)){
HXLINE( 560)						 ::Dynamic f5 = fl->__get(_g11);
HXDLIN( 560)						_g11 = (_g11 + 1);
...
HXDLIN( 568)					while((_g12 < cases->length)){
HXLINE( 568)						 ::Dynamic c1 = cases->__get(_g12);
HXDLIN( 568)						_g12 = (_g12 + 1);
HXLINE( 569)						{
HXLINE( 569)							int _g13 = 0;
HXDLIN( 569)							::Array< ::Dynamic> _g14 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN( 569)							while((_g13 < _g14->length)){
HXLINE( 569)								 ::hscript::Expr v5 = _g14->__get(_g13).StaticCast<  ::hscript::Expr >();
HXDLIN( 569)								_g13 = (_g13 + 1);
...
HXLINE( 395)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 582)				 ::hscript::Expr e27 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 583)				return this->expr(e27);
            			}
            			break;
            			case (int)26: {
HXLINE( 584)				 ::hscript::Expr e28 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
