...
HXDLIN( 277)		switch((int)(_g->_hx_getIndex())){
            			case (int)2: {
HXLINE( 280)				 ::hscript::CType t = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
...
HXLINE( 278)				return true;
            			...
            			break;
            			case (int)6: {
HXLINE( 282)				 ::hscript::Expr e2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 283)				bool prefix = _g->_hx_getBool(1);
...
HXLINE( 283)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 281)				 ::hscript::Expr e11 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 281)					return this->isBlock(e11);
            			...
            			break;
            			case (int)10: {
HXLINE( 284)				 ::hscript::Expr e4 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 286)				 ::hscript::Expr e5 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				return this->isBlock(e5);
            			}
            			break;
            			case (int)14: {
HXLINE( 279)				 ::hscript::Expr e6 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 287)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 288)				 ::hscript::Expr e8 = _g->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
...
HXLINE( 278)				return true;
            			...
            			break;
            			case (int)24: {
HXLINE( 285)				 ::hscript::Expr e9 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e9);
            			}
            			break;
            			case (int)25: {
HXLINE( 289)				 ::hscript::Expr e10 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 448)							 ::hscript::Const _gc = _g->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN( 448)							switch((int)(_gc->_hx_getIndex())){
            								case (int)0: {
HXLINE( 446)									int i = _gc->_hx_getInt(0);
HXLINE( 447)									return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CInt(-(i)));
            								}
            								break;
            								case (int)1: {
HXLINE( 448)									Float f = _gc->_hx_getFloat(0);
...
HXLINE( 374)								return this->parseExprNext(::hscript::Expr_obj::EParent(e2));
            							...
            							break;
            							case (int)9: {
HXLINE( 389)								 ::hscript::Expr _g1 = e2;
HXDLIN( 389)								if ((_g1->_hx_getIndex() == 1)) {
HXLINE( 390)									::String v = _g1->_hx_getString(0);
...
HXLINE( 380)											return this->parseExprNext(::hscript::Expr_obj::ECheckType(e2,t1));
            										...
            										break;
            										case (int)9: {
HXLINE( 382)											 ::hscript::Expr _g2 = e2;
HXDLIN( 382)											if ((_g2->_hx_getIndex() == 1)) {
HXLINE( 383)												::String v1 = _g2->_hx_getString(0);
...
HXLINE( 468)						switch((int)(a1->__get(0).StaticCast<  ::hscript::Expr >()->_hx_getIndex())){
            							case (int)10: {
...
HXLINE( 534)				edef = ::hscript::Expr_obj::EParent(this->mapCompr(tmp,e2));
            			...
            			break;
            			case (int)4: {
HXLINE( 543)				::Array< ::Dynamic> _ge = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 543)				if ((_ge->length == 1)) {
HXLINE( 543)					 ::hscript::Expr e1 = _ge->__get(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 961)									 ::hscript::Token _g1 = this->token();
HXDLIN( 961)									if (::hx::IsNull( _g1 )) {
HXLINE( 973)										 ::hscript::Token t6 = _g1;
HXDLIN( 973)										return this->unexpected(t6);
            									}
            									else {
HXLINE( 961)										switch((int)(_g1->_hx_getIndex())){
            											case (int)5: {
...
HXLINE( 970)												return withReturn(args1);
            											...
            											break;
            											default:{
HXLINE( 973)												 ::hscript::Token t8 = _g1;
...
HXLINE( 947)										::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 947)										{
HXLINE( 947)											int _g3 = 0;
HXDLIN( 947)											::Array< ::Dynamic> _g4 = this->parseFunctionArgs();
HXDLIN( 947)											while((_g3 < _g4->length)){
HXLINE( 947)												 ::Dynamic arg = _g4->__get(_g3);
HXDLIN( 947)												_g3 = (_g3 + 1);
HXLINE( 948)												{
HXLINE( 948)													 ::hscript::Expr _g5 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 949)													if (::hx::IsNotNull( _g5 )) {
HXLINE( 950)														 ::hscript::Expr v1 = _g5;
...
HXDLIN( 954)												_g2->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp));
            											}
            										}
HXLINE( 947)										::Array< ::Dynamic> args2 = _g2;
HXLINE( 957)										return withReturn(args2);
            									}
            									else {
HXLINE( 960)										 ::hscript::CType t9 = this->parseType();
HXLINE( 961)										 ::hscript::Token _g6 = this->token();
HXDLIN( 961)										if (::hx::IsNull( _g6 )) {
HXLINE( 973)											 ::hscript::Token t10 = _g6;
HXDLIN( 973)											return this->unexpected(t10);
            										}
            										else {
HXLINE( 961)											switch((int)(_g6->_hx_getIndex())){
            												case (int)5: {
...
HXLINE( 970)													return withReturn(args3);
            												...
            												break;
            												default:{
HXLINE( 973)													 ::hscript::Token t12 = _g6;
HXDLIN( 973)													return this->unexpected(t12);
            							...
            							break;
            							case (int)5: {
HXLINE( 947)								::Array< ::Dynamic> _g7 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 947)								{
HXLINE( 947)									int _g8 = 0;
HXDLIN( 947)									::Array< ::Dynamic> _g9 = this->parseFunctionArgs();
HXDLIN( 947)									while((_g8 < _g9->length)){
HXLINE( 947)										 ::Dynamic arg1 = _g9->__get(_g8);
HXDLIN( 947)										_g8 = (_g8 + 1);
HXLINE( 948)										{
HXLINE( 948)											 ::hscript::Expr _g10 = arg1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 949)											if (::hx::IsNotNull( _g10 )) {
HXLINE( 950)												 ::hscript::Expr v2 = _g10;
HXLINE( 951)												if (!(this->resumeErrors)) {
HXLINE( 951)													HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            												}
            											}
...
HXDLIN( 954)										_g7->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp1));
            									}
            								}
HXLINE( 947)								::Array< ::Dynamic> args4 = _g7;
HXLINE( 957)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 960)								 ::hscript::CType t13 = this->parseType();
HXLINE( 961)								 ::hscript::Token _g11 = this->token();
HXDLIN( 961)								if (::hx::IsNull( _g11 )) {
HXLINE( 973)									 ::hscript::Token t14 = _g11;
HXDLIN( 973)									return this->unexpected(t14);
            								}
            								else {
HXLINE( 961)									switch((int)(_g11->_hx_getIndex())){
            										case (int)5: {
...
HXLINE( 970)											return withReturn(args5);
            										...
            										break;
            										default:{
HXLINE( 973)											 ::hscript::Token t16 = _g11;
...
HXLINE( 981)							switch((int)(t->_hx_getIndex())){
            								case (int)2: {
HXLINE( 989)									::String _gs = t->_hx_getString(0);
HXDLIN( 989)									if ((_gs == HX_("var",e7,de,59,00))) {
...
HXLINE(1026)			::Array< ::Dynamic> args = t2->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE(1380)									switch((int)(tk->_hx_getIndex())){
            										case (int)1: {
HXLINE(1381)											 ::hscript::Const _gc = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN(1381)											if ((_gc->_hx_getIndex() == 0)) {
HXLINE(1381)												int e = _gc->_hx_getInt(0);
HXDLIN(1381)												pow = e;
            											}
            											else {
...
HXLINE(1385)														 ::hscript::Const _gc1 = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN(1385)														if ((_gc1->_hx_getIndex() == 0)) {
HXLINE(1385)															int e1 = _gc1->_hx_getInt(0);
HXDLIN(1385)															pow = -(e1);
            														}
            														else {
...
HXLINE(1592)				return this->evalPreproCond(e1);
            			...
            			break;
            			case (int)6: {
HXLINE(1595)				 ::hscript::Expr _ge = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN(1595)				 ::hscript::Expr _ge1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1595)				::String _hx_switch_0 = e->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1593)					 ::hscript::Expr e11 = _ge;
HXDLIN(1593)					 ::hscript::Expr e2 = _ge1;
...
HXLINE(1595)					 ::hscript::Expr e12 = _ge;
HXDLIN(1595)					 ::hscript::Expr e21 = _ge1;
...
HXLINE(1599)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1589)				if ((e->_hx_getString(0) == HX_("!",21,00,00,00))) {
