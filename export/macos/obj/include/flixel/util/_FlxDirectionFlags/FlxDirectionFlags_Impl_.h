...
class HXCPP_CLASS_ATTRIBUTES FlxDirectionFlags_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic _hx_and;
		static Dynamic _hx_and_dyn() { return _hx_and;}
		static  ::Dynamic _hx_or;
		static Dynamic _hx_or_dyn() { return _hx_or;}
		static  ::Dynamic gt;
		static Dynamic gt_dyn() { return gt;}
		static  ::Dynamic lt;
		static Dynamic lt_dyn() { return lt;}
		static  ::Dynamic gte;
		static Dynamic gte_dyn() { return gte;}
		static  ::Dynamic lte;
		static Dynamic lte_dyn() { return lte;}
};
