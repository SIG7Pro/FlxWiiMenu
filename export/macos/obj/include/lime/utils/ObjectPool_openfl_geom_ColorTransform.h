...
class HXCPP_CLASS_ATTRIBUTES ObjectPool_openfl_geom_ColorTransform_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("ObjectPool_openfl_geom_ColorTransform",41,7d,9a,c8); }
		...
		void remove( ::openfl::geom::ColorTransform object);
		::Dynamic remove_dyn();
